...
const Site = () => (
    <Layout title="Hanabi Event">
        ...
        <P>
            HANABI EVENT est une association loi 1901 créée en 2021 dont le but
            est de promouvoir, les cultures asiatiques (Chine, Corée, Japon,
            Thaïlande, Vietnam, etc.…) en France sous des formats
            ...
            avec les personnes qui ne sont pas membres afin de partager les
            projets de l&apos;association en permettant la communication
        ...
        <SiteImage src="/images/sites/hanabi-event.jpg" alt="Hanabi Event" />
